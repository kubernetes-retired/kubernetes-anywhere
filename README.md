...
> but no need to set it all up from scratch. Deploy Weave Net first, then `docker run` cluster
...
## Feature Summary
  ...
  - **Fully-containerised cluster deployment**
...
for storing [PKI container images](#containerised-provisioning-of-certificates--way-easier-then-ever).
